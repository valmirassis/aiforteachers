    ...
    <main class="container my-5">
      ...
      <header class="mb-4">
        <h1 class="h3">
         <i class="fas fa-list-ul"></i> Informações Conversor/Gerador de Áudio
        </h1>
      </header>
...
<section class="mb-5">
              <h2 class="h4 fw-semibold">  ⚙️ Como utilizar o gerador Conversor/Gerador de Áudio</h2>
