   ...
   const tipoAtividadeRadios = document.querySelectorAll('input[name="tipo_atividade"]');
        tipoAtividadeRadios.forEach(radio => {
            radio.addEventListener('change', () => {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            resultadoDiv.innerHTML = '<div class="loading"> <div class="spinner2"></div>  Gerando atividade, aguarde...</div>';

            const formData = new FormData(form);

            fetch('services/activity_generator_service.php', {
                method: 'POST',
                body: formData
            })
            ...
            .catch(error => {
                resultadoDiv.innerHTML = '<div class="alert alert-danger">Erro ao gerar atividade.</div>';
            });
        });
