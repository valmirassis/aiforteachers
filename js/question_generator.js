    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            resultadoDiv.innerHTML = '<div class="loading"> <div class="spinner2"></div>  Gerando questões, aguarde...</div>';

            const formData = new FormData(form);

            fetch('services/question_generator_service.php', {
                method: 'POST',
                body: formData
            })
            ...
            .catch(error => {
                resultadoDiv.innerHTML = '<div class="alert alert-danger">Erro ao gerar questões.</div>';
            });
        });
    });